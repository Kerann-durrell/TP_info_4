...
from .views import traiter_exercice_1, traiter_exercice_2, traiter_exercice_3, traiter_exercice_4, traiter_exercice_5, traiter_exercice_6, traiter_exercice_7, traiter_exercice_8, traiter_exercice_9, traiter_exercice_10, traiter_exercice_11
...
urlpatterns = [
    ...
    path('exercice10/', traiter_exercice_10),
